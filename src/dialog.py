...
if __name__ == "__main__":
    """
    python dialog.py ../data/PreprocessedBinaryData/saya_empathetic_labeled/  --path ../model/saya_empathetic_labeled_MODEL/fine_tuned_models/checkpoint_best.pt  --beam 80  --min-len 10  --source-lang src  --target-lang dst  --tokenizer space  --bpe sentencepiece  --sentencepiece-model ../model/spm/sp_oall_32k.model  --no-repeat-ngram-size 3  --nbest 80  --sampling  --sampling-topp 0.9  --temperature 1.0 --show-nbest 5
    """
    main()
